    ...
    results: [
      {
        ...
        seatsWon: 237,
        districtSeats: 168,
        proportionalSeats: 69,
        totalVotes: 20660185n,
        voteShare: 34.96,
      },
      {
        partyName: "民主党",
        seatsWon: 177,
        districtSeats: 105,
        proportionalSeats: 72,
        totalVotes: 22095636n,
        voteShare: 37.39,
      },
      {
        partyName: "公明党",
      ...
      { partyName: "保守新党", seatsWon: 4, districtSeats: 4, proportionalSeats: 0 },
      { partyName: "無所属", seatsWon: 13, districtSeats: 13, proportionalSeats: 0 },
    ],
  },
  {
    name: "第44回衆議院議員総選挙",
    ...
    results: [
      {
        ...
        seatsWon: 296,
        districtSeats: 219,
        proportionalSeats: 77,
        totalVotes: 25887798n,
        voteShare: 38.18,
      },
      {
        partyName: "民主党",
        seatsWon: 113,
        districtSeats: 52,
        proportionalSeats: 61,
        totalVotes: 21036425n,
        voteShare: 31.02,
      },
      {
        partyName: "公明党",
      ...
      { partyName: "無所属", seatsWon: 18, districtSeats: 18, proportionalSeats: 0 },
    ],
  },
  {
    name: "第45回衆議院議員総選挙",
    ...
    results: [
      {
        ...
        seatsWon: 308,
        districtSeats: 221,
        proportionalSeats: 87,
        totalVotes: 29844799n,
        voteShare: 42.41,
      },
      {
        partyName: "自由民主党",
        seatsWon: 119,
        districtSeats: 64,
        proportionalSeats: 55,
        totalVotes: 18810217n,
        voteShare: 26.73,
      },
      {
        partyName: "公明党",
    ...
    results: [
      {
        ...
        seatsWon: 294,
        districtSeats: 237,
        proportionalSeats: 57,
        totalVotes: 16624457n,
        voteShare: 27.62,
      },
      {
        partyName: "民主党",
      ...
      },
      {
        ...
        seatsWon: 54,
        districtSeats: 14,
        proportionalSeats: 40,
        totalVotes: 12262228n,
        voteShare: 20.38,
      },
      {
        partyName: "公明党",
    ...
    results: [
      {
        ...
        seatsWon: 291,
        districtSeats: 223,
        proportionalSeats: 68,
        totalVotes: 17658916n,
        voteShare: 33.11,
      },
      {
        partyName: "民主党",
    ...
    results: [
      {
        ...
        seatsWon: 284,
        districtSeats: 218,
        proportionalSeats: 66,
        totalVotes: 18555717n,
        voteShare: 33.28,
      },
      {
        partyName: "立憲民主党",
        seatsWon: 55,
        districtSeats: 18,
        proportionalSeats: 37,
        totalVotes: 11084890n,
        voteShare: 19.88,
      },
      {
        partyName: "希望の党",
  ...
  },
  {
    ...
    results: [
      ...
      },
      {
        ...
        seatsWon: 96,
        districtSeats: 57,
        proportionalSeats: 39,
        totalVotes: 11492095n,
        voteShare: 20.0,
      },
      {
        partyName: "日本維新の会",
    ...
    results: [
      {
        ...
        seatsWon: 191,
        districtSeats: 132,
        proportionalSeats: 59,
        totalVotes: 14582680n,
        voteShare: 26.73,
      },
      {
        partyName: "立憲民主党",
        seatsWon: 148,
        districtSeats: 104,
        proportionalSeats: 44,
        totalVotes: 11535827n,
        voteShare: 21.14,
      },
      {
        partyName: "日本維新の会",
    ...
    results: [
      {
        ...
        seatsWon: 316,
        districtSeats: 249,
        proportionalSeats: 67,
        totalVotes: 21026139n,
        voteShare: 36.72,
      },
      {
        partyName: "中道改革連合",
        seatsWon: 49,
        districtSeats: 7,
        proportionalSeats: 42,
        totalVotes: 10438801n,
        voteShare: 18.23,
      },
      {
        partyName: "日本維新の会",
...
const HOUSE_OF_COUNCILLORS_ELECTIONS: ElectionData[] = [
    ...
    results: [
      {
        ...
        seatsWon: 50,
        districtSeats: 31,
        proportionalSeats: 19,
        totalVotes: 21137458n,
        voteShare: 37.79,
      },
      {
        partyName: "自由民主党",
  ...
  },
  {
    ...
    results: [
      ...
      { partyName: "無所属", seatsWon: 7, districtSeats: 7, proportionalSeats: 0 },
    ],
  },
  {
    name: "第22回参議院議員通常選挙",
...
export async function seedElections(): Promise<void> {
  ...
  for (const electionData of ALL_ELECTIONS) {
    ...
    electionCount++;
    console.log(`[elections] 選挙: ${electionData.name} (${electionData.date}) — ${election.id}`);

    // 各政党の選挙結果を upsert
    for (const result of electionData.results) {
      const partyId = await resolvePartyId(result.partyName, partyCache);
      if (!partyId) {
        console.warn(`[elections]   スキップ: ${result.partyName} (政党未解決)`);
        continue;
      }
  ...
  console.log(`[elections] 完了 — ${electionCount}選挙, ${resultCount}件の結果を登録`);
}
